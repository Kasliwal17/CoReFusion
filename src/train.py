...
if __name__ == '__main__':
    ...
    parser.add_argument('--th_dir', type=str, required=False, default='.Dataset/train_val/training/train_input_THER_LR_bicubic')
    ...
    parser.add_argument('--th_val_dir', type=str, required=False, default='.Dataset/train_val/validation/valid_input_THER_LR_bicubic')
